...
const astrologyMsgs = [
  ...
  "One’s astrological horoscope may be compared metaphorically to one’s genetic heritage; it cannot be changed, but we can do what we may with what we are given.",
...
const displayMessage = () => {
  switch (categorySelector) {
    case 1:
      return astrologyMsgs[messageSelector];
    case 2:
      return inspiringMsgs[messageSelector];
    default:
      return nonsenseMsgs[messageSelector];
  }
};
